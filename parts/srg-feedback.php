<section
    ...
    id="testi-sec"
    data-bg-src="../assets/img/bg/testi_bg_5.jpg">
    <div class="container">
        ...
        <div class="slider-wrap text-center">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="testi-grid style2">
                            ...
                            <p class="box-text">
                                SRG has best quality plumbing & electrical services. They fixed my water heater and wiring issues quickly.
                                Professional team, fair pricing, and great customer support. Highly recommended for all home services.
                            </p>
                        </div>
                    </div>
                    <div class="swiper-slide">
            ...
            <div class="slider-controller">
                ...
                <div
                    ...
                    data-slider-id="#testiSlider5"></div>
                <button
