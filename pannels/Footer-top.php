         ...
         <div class="container">
             <div class="row justify-content-between">
                     ...
                     <div class="widget footer-widget">
                         <div class="th-widget-about">
                             <div class="about-logo">
                                 <a href="home-handyman.html"><img src="../assets/web/images/srg-management-logo.jpg" class="bg-white p-1" style="border-radius: 7px;" width="140" height="50" alt="Rakar" /></a>
                             </div>
                             <p class="about-text">
                 ...
                 <div class="col-md-6 col-xl-auto">
                     <div class="widget widget_nav_menu footer-widget">
                         <h3 class="widget_title">
                             <!-- <img src="/assets/img/icon/footer_title5.svg" alt="icon" /> Our -->
                             Services
                         </h3>
                         <div class="menu-all-pages-container">
                             <ul class="menu">
                                 <li><a href="javascript:void(0)">Refrigerator</a></li>
                                 <li><a href="javascript:void(0)">Microwave</a></li>
                                 <li><a href="javascript:void(0)">Cookware Stove</a></li>
                                 <li><a href="javascript:void(0)">Washing Machine</a></li>
                                 <li><a href="javascript:void(0)">Juicer Mixer</a></li>
                                 <li>
                                     <a href="javascript:void(0)">Generator Install</a>
                                 </li>
                             </ul>
                         </div>
                     </div>
                     ...
                     <div class="widget newsletter-widget footer-widget">
                         ...
                         <form class="newsletter-form">
                             ...
                             <button type="submit" class="th-btn style3">
                                 Subscribe<i class="far fa-arrow-right ms-2"></i>
                             </button>
                         </form>
                     </div>
                 </div>
             ...
             <div class="row gy-2 align-items-center">
                 <div class="col-md-6">
                     <p class="copyright-text">
                         ...
                         <a href="javascript:void(0)">SRG</a>. All Rights Reserved.
                     </p>
                 </div>
