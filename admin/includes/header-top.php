...
<head>
	...
	<meta name="description" content="IGNOU INFORMATION">
	<meta property="og:title" content="IGNOU INFORMATION">
	<meta property="og:description" content="IGNOU INFORMATION">
	<meta property="og:image" content="">
	<meta name="format-detection" content="telephone=no">
    <link rel="icon" type="image/png" href="/admin/admin-assets/images/favicon.jpg">
	...
	<!-- PAGE TITLE HERE -->
	<title>Admin | DUSOL INFORMATION </title>
	<!-- FAVICONS ICON -->
	<!-- <link rel="shortcut icon" type="image/png" href="/admin/admin-assets/images/IGNOU INFORMATION.png"> -->
