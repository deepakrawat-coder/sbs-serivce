...
$id = intval($_GET['id']);
// $getdataQuery = $conn->query("SELECT * FROM why_choose_us WHERE ID = $id");
...
$whyChooseQuery = $conn->query("SELECT *  FROM why_choose_us WHERE Product_id = '$product_id'");
?>

<div class="modal-header">
    <h5 class="modal-title">Edit Why Choose</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
</div>

<div class="card-body">
    <div class="form-validation">
        <form class="needs-validation" role="form" id="form-add-stream" action="/admin/app/why_choose/update"
