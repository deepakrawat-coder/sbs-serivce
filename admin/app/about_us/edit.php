...
if (isset($_GET['id'])) {
    ...
    $id = intval($_GET['id']);
    $getdataQuery = $conn->query("SELECT * FROM about_us WHERE ID = $id");
...
<div class="card-body">
    <div class="form-validation">
        <form class="needs-validation" role="form" id="form-add-stream" action="/admin/app/about_us/update" method="POST"
            ...
            <div class="row">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" class="form-control" name="year_exp" value="<?= $getdata['Experience'] ?>" required>
                </div>

                <div class="mb-3 col-md-6">
                    <label class="form-label">Circle Text <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="circle_text" value="<?= $getdata['Circle_Text'] ?>" required>
                </div>
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="tel" id="number" class="form-control" name="phone"
                        value="<?= $getdata['Phone'] ?>" onkeypress="return onlyNumberKey(event)" maxlength="10" minlength="10"
