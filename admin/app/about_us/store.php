...
if (isset($_POST['name'])) {
    ...
    if (!empty($_FILES["photo"]["name"])) {
        $filename = uploadImage($conn, "photo", "about");
    } else {
    ...
    $query = "INSERT INTO about_us (`Name`, `Product_id`, `Image`, `Phone`,`Experience`, `Circle_Text`, `Content`) 
              VALUES ('$name', '$product_ID', '$filename', '$phone', '$exp', '$circle_text','$content')";
