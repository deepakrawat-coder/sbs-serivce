...
$getdataQuery = $conn->query("SELECT * FROM working_process WHERE ID = $id");
$getdata = $getdataQuery->fetch_assoc();

$product_id = $getdata['Product_id'];

$whyChooseQuery = $conn->query("SELECT *  FROM working_process WHERE Product_id = '$product_id'");
?>


<div class="modal-header">
    <h5 class="modal-title">Edit Working Process</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
</div>

<div class="card-body">
    <div class="form-validation">
        <form class="needs-validation" role="form" id="form-add-stream" action="/admin/app/working_process/update"
            ...
            <div class="row">
                ...
                <div id="dynamicFields">
                    ...
                    <?php while ($row = $whyChooseQuery->fetch_assoc()) { ?>
                        ...
                        <div class="box border p-3 mb-3">
                            ...
                            <button type="button" class="btn btn-danger btn-sm mt-2" onclick="removeBox(this)">
                                Remove
                            </button>
