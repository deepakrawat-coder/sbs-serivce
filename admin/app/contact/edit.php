...
$id = intval($_GET['id']);
$getdataQuery = $conn->query("SELECT * FROM contact WHERE ID = $id");
...
<div class="card-body">
    <div class="form-validation">
        <form class="needs-validation" role="form" id="form-add-stream" action="/admin/app/contact/update" method="POST"
            ...
            <div class="row">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="tel" name="phone" value="<?= $getdata['Phone'] ?>" id="number" placeholder="Phone No.*"
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="email" name="email" value="<?= $getdata['Email'] ?>" id="email"
