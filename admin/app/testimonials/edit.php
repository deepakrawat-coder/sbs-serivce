...
if (isset($_GET['id'])) {
    ...
    $id = intval($_GET['id']);
    $getdataQuery = $conn->query("SELECT * FROM testimonials WHERE ID = $id");
...
<div class="card-body">
    <div class="form-validation">
        <form class="needs-validation" role="form" id="form-add-stream" action="/admin/app/testimonials/update"
