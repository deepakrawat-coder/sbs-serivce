                ...
                <div class="hero-inner">
                    <div class="container">
                        <div class="hero-style2">
                            ...
                            <h1 class="hero-title"><span class="title1" data-ani="slideinup" data-ani-delay="0.2s">We provide skilled</span> <span class="title2" data-ani="slideinup" data-ani-delay="0.4s">Manpower <span class="text-theme">Solutions</span></span></h1>
                            <p class="hero-text" data-ani="slideinup" data-ani-delay="0.6s">We believe in providing top quality workforce and are so confident in our service that we back it up with complete reliability.</p>
                            <a href="lk-services.html" class="th-btn2 style3" data-ani="slideinup" data-ani-delay="0.8s">Our All Services<i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="hero-img" data-ani="slideinright" data-ani-delay="0.2s"><img src="../assets/img/hero/hero_2_1.png" alt="Manpower Solutions"></div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="hero-inner">
...
<div class="overflow-hidden space background-image" id="about-sec" style="background-image: url(&quot;assets/img/bg/pattern_bg_5.png&quot;);">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xl-4 text-center text-xl-start">
                <div class="title-area mb-37"><span class="sub-title"><span class="line"></span>About Lord Krishna</span>
                    <h2 class="sec-title">Give everything to Lord Krishna Manpower Services.</h2>
                    <p class="sec-text">Welcome to Lord Krishna Manpower Services when it comes to skilled workforce and staffing solutions, we are the best option. We are happy that you came upon our website.</p>
                </div>
                ...
                <div class="btn-group justify-content-center btn-mr"><a href="lk-about.html" class="th-btn style4">Discover More<i class="far fa-arrow-right ms-2"></i></a>
                    <div class="call-btn">
            ...
            <div class="col-xl-4 my-5 my-xl-0">
                <div class="rounded-img1"><img class="w-100" src="../assets/img/normal/about_3.jpg" alt="Lord Krishna Manpower"></div>
            </div>
            <div class="col-xl-4">
                <div class="contact-process-wrap no-bg">
                    <div class="contact-process">
                        ...
                        <div class="media-body">
                            ...
                            <p class="box-text text-body">Willing to go the extra mile to provide quality workforce. We are based across India and serve all major cities.</p>
                        </div>
                    </div>
                    <div class="contact-process">
                        ...
                        <div class="media-body">
                            ...
                            <p class="box-text text-body">We provide detailed estimation for temporary or permanent staffing based on your requirements and budget.</p>
                        </div>
                    </div>
                    <div class="contact-process">
                        ...
                        <div class="media-body">
                            ...
                            <p class="box-text text-body">We deploy verified workers within 24 hours with complete documentation and compliance support.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="contact-process-wrap lord-krishna">
                        <div class="contact-process">
                            ...
                            <div class="media-body">
                                ...
                                <p class="box-text">
                                    Tell us your workforce requirements - skilled, semi-skilled, or support staff for your business needs.
                                </p>
                            </div>
                        </div>
                        <div class="contact-process">
                            ...
                            <div class="media-body">
                                ...
                                <p class="box-text">
                                    We provide detailed estimation for temporary or permanent staffing based on your budget and timeline.
                                </p>
                            </div>
                        </div>
                        <div class="contact-process">
                            ...
                            <div class="media-body">
                                ...
                                <p class="box-text">
                                    All our workers are background verified, licensed, and insured before deployment to your location.
                                </p>
                            </div>
                        </div>
                        <div class="contact-process">
                            ...
                            <div class="media-body">
                                <h3 class="box-title">Quick Deployment</h3>
                                <p class="box-text">
                                    We deploy verified workforce within 24 hours with complete documentation and compliance support.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-6 text-center text-xl-start align-self-center space-extra">
                <div class="title-area">
                    <span class="sub-title"><img src="../assets/img/theme-img/title_icon.svg" alt="shape">Hire Workforce Today</span>
                    <h2 class="sec-title">Request a free quote</h2>
                </div>
                <form action="https://html.themehour.net/rakar/demo/mail.php" method="POST" class="input-light ajax-contact pb-30 pb-md-0">
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            <textarea name="message" id="message" cols="30" rows="3" class="form-control" placeholder="Tell us about your workforce requirements"></textarea>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-md-auto">
                <div class="sec-btn mt-n3 mt-md-0"><a href="lk-blog.html" class="th-btn style4">View All Articles<i class="far fa-arrow-right ms-2"></i></a></div>
            </div>
        </div>
        <div class="row gy-4">
            <!-- Blog 1 -->
            <div class="col-xl-4 col-md-6">
                <div class="blog-card style3">
                    <a href="lk-blog-details.html" class="blog-img"><img src="../assets/img/blog/blog_2_1.jpg" alt="blog image"> </a>
                    ...
                    <div class="blog-content">
                        ...
                        <h3 class="box-title"><a href="lk-blog-details.html">5 Tips to Hire Skilled Workers for Your Business</a></h3>
                        <p class="box-text">Learn how to find, verify, and hire skilled workforce for your business. Complete guide to manpower recruitment and staffing solutions.</p>
                    </div>
                </div>
            </div>
            <!-- Blog 2 -->
            <div class="col-xl-4 col-md-6">
                <div class="blog-card style3">
                    <a href="lk-blog-details.html" class="blog-img"><img src="../assets/img/blog/blog_2_2.jpg" alt="blog image"> </a>
                    ...
                    <div class="blog-content">
                        ...
                        <h3 class="box-title"><a href="lk-blog-details.html">Benefits of Temporary Staffing for Industries</a></h3>
                        <p class="box-text">Flexible workforce solutions for seasonal demands and project-based work. Reduce costs and improve efficiency with temporary staffing.</p>
                    </div>
                </div>
            </div>
            <!-- Blog 3 -->
            <div class="col-xl-4 col-md-6">
                <div class="blog-card style3">
                    <a href="lk-blog-details.html" class="blog-img"><img src="../assets/img/blog/blog_2_3.jpg" alt="blog image"> </a>
                    ...
                    <div class="blog-content">
                        ...
                        <h3 class="box-title"><a href="lk-blog-details.html">Essential Labor Law Compliance for Employers</a></h3>
                        <p class="box-text">Everything you need to know about labor laws, contracts, insurance, and statutory compliance for your workforce.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-7 text-center text-xl-start">
                <div class="space">
                    <div class="title-area mb-35">
                        <span class="sub-title2"><img src="../assets/img/theme-img/title_icon4_white.svg" alt="shape">FAQ's</span>
                    ...
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="accordion-card style3 active">
                            ...
                            <div id="collapse-1" class="accordion-collapse collapse show" aria-labelledby="collapse-item-1" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p class="faq-text">
                                        We provide skilled workers (plumbers, electricians, carpenters, welders), semi-skilled workers (helpers, assistants),
                                        industrial staff (machine operators, supervisors), and support staff (office peons, housekeeping, security guards)
                        ...
                        <div class="accordion-card style3">
                            ...
                            <div id="collapse-2" class="accordion-collapse collapse" aria-labelledby="collapse-item-2" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p class="faq-text">
                                        We deploy verified workforce within 24 hours of your request. Our team handles all documentation,
                                        background verification, and compliance requirements before deployment to ensure quality and reliability.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-card style3">
                            ...
                            <div id="collapse-3" class="accordion-collapse collapse" aria-labelledby="collapse-item-3" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p class="faq-text">
                                        Yes, we offer both temporary and permanent staffing solutions. Temporary staffing is ideal for seasonal demands,
                                        project-based work, or covering employee absences. Permanent hiring is available for full-time positions with
                        ...
                        <div class="accordion-card style3">
                            ...
                            <div id="collapse-4" class="accordion-collapse collapse" aria-labelledby="collapse-item-4" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p class="faq-text">
                                        Absolutely! We offer complete payroll management services including salary processing, tax compliance,
                                        PF/ESIC contributions, and labor law compliance. Our team ensures all statutory requirements are met
                                        for your workforce.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="accordion-card style3">
                            ...
                            <div id="collapse-5" class="accordion-collapse collapse" aria-labelledby="collapse-item-5" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p class="faq-text">
                                        Yes, all our workers undergo thorough background verification, identity checks, and skill assessments.
                                        They are properly licensed and insured, ensuring complete safety and reliability for your business.
                                    </p>
                                </div>
                            </div>
                        </div>
